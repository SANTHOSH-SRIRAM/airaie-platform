...
> **Scope.** Implementation deep-dive. For the *concept* — what a Board is, the Mode dial that lives on it, and the Card-page UI that hangs off it — read:
>
> - [`../concepts/01-CORE-MODEL.md`](../concepts/01-CORE-MODEL.md) §"Board"
> - [`../concepts/02-GOVERNANCE-AND-MODES.md`](../concepts/02-GOVERNANCE-AND-MODES.md) (Modes, Gates, Evidence, Trust, Roles)
> - [`../concepts/03-CARDS-AS-PAGES.md`](../concepts/03-CARDS-AS-PAGES.md) (the Card-page that lives on a Board)
>
