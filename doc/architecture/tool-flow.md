...
> **Conceptually re-anchored:** 2026-04-26

---

> **Scope.** Implementation deep-dive on the tool system end-to-end. For the *concept* and *contract* — what a Tool is, what authors must commit to, and how Trust progresses — read:
>
> - [`../concepts/01-CORE-MODEL.md`](../concepts/01-CORE-MODEL.md) §"Tool" and §"Run / NodeRun"
> - [`../concepts/05-TOOL-AUTHOR-CONTRACT.md`](../concepts/05-TOOL-AUTHOR-CONTRACT.md) (the pact)
> - [`../concepts/04-RENDERER-REGISTRY.md`](../concepts/04-RENDERER-REGISTRY.md) (how Tool outputs become UI)
> - [`../protocol/ATP-SPEC.md`](../protocol/ATP-SPEC.md) (the wire format)
>
> Sections below describe the wired flow — registry, dispatch, runner, post-processing — and remain authoritative for code-level detail.
