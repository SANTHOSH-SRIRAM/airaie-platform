...
> **Scope.** Implementation deep-dive on the tool system architecture. For the *concept* and *contract* — what a Tool is, what authors must emit, and how Trust progresses — read:
>
> - [`../concepts/01-CORE-MODEL.md`](../concepts/01-CORE-MODEL.md) §"Tool"
> - [`../concepts/05-TOOL-AUTHOR-CONTRACT.md`](../concepts/05-TOOL-AUTHOR-CONTRACT.md) (the pact, including format pacts)
...
>
> See also [`./tool-flow.md`](./tool-flow.md) for the end-to-end flow narrative. This doc is the layered architecture reference.
