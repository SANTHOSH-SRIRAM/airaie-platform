...
> **Scope.** Implementation deep-dive. For the *concept* — what a Workflow is, how it's compiled from an IntentSpec, and how it relates to Cards and Agents — read:
>
> - [`../concepts/01-CORE-MODEL.md`](../concepts/01-CORE-MODEL.md) §"ExecutionPlan" and §"Workflow / Workflow Version"
> - [`../concepts/03-CARDS-AS-PAGES.md`](../concepts/03-CARDS-AS-PAGES.md) §"Method section" (Workflows surface as the Card's Method)
> - [`../implementation/new_design/WORKFLOW_DSL.md`](../implementation/new_design/WORKFLOW_DSL.md) (the YAML format)
>
> Sections below remain current for execution semantics, error handling, and code-level details.
